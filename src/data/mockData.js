...
export const appRankings = {
    topFree: [
        ...
        { id: 'af6', name: 'PayPal', publisher: 'PayPal Inc.', downloads: '9,500,000', change: '+3%', icon: '💳', color: '#003087', type: 'app', storeUrl: 'https://www.paypal.com' },
        { id: 'af7', name: 'Cash App', publisher: 'Block Inc.', downloads: '8,200,000', change: '+6%', icon: '💵', color: '#00d64f', type: 'app', storeUrl: 'https://cash.app' },
        { id: 'af8', name: 'Duolingo', publisher: 'Duolingo Inc.', downloads: '12,000,000', change: '+18%', icon: '🦉', color: '#84cc16', type: 'app', storeUrl: 'https://www.duolingo.com' },
        { id: 'af9', name: 'Khan Academy', publisher: 'Khan Academy', downloads: '5,400,000', change: '+9%', icon: '📚', color: '#14b8a6', type: 'app', storeUrl: 'https://www.khanacademy.org' },
        { id: 'af10', name: 'Strava', publisher: 'Strava Inc.', downloads: '6,100,000', change: '+11%', icon: '🏃', color: '#fc4c02', type: 'app', storeUrl: 'https://www.strava.com' },
        { id: 'af11', name: 'Calm', publisher: 'Calm.com LLC', downloads: '5,800,000', change: '+7%', icon: '🧘', color: '#6ba3d6', type: 'app', storeUrl: 'https://www.calm.com' },
        { id: 'af12', name: 'MyFitnessPal', publisher: 'MyFitnessPal Inc.', downloads: '4,900,000', change: '+4%', icon: '🥗', color: '#4caf50', type: 'app', storeUrl: 'https://www.myfitnesspal.com' },
        { id: 'af13', name: 'VSCO', publisher: 'VSCO', downloads: '4,200,000', change: '+2%', icon: '📸', color: '#1a1a1a', type: 'app', storeUrl: 'https://vsco.co' },
        { id: 'af14', name: 'Facetune', publisher: 'Lightricks Ltd.', downloads: '3,800,000', change: '+5%', icon: '✨', color: '#7c3aed', type: 'app', storeUrl: 'https://www.facetuneapp.com' },
        { id: 'af15', name: 'Pinterest', publisher: 'Pinterest Inc.', downloads: '7,600,000', change: '+8%', icon: '📌', color: '#e60023', type: 'app', storeUrl: 'https://www.pinterest.com' },
        { id: 'af16', name: 'Etsy', publisher: 'Etsy Inc.', downloads: '3,400,000', change: '+3%', icon: '🛍️', color: '#f56400', type: 'app', storeUrl: 'https://www.etsy.com' },
        { id: 'af17', name: 'SHEIN', publisher: 'SHEIN Group', downloads: '5,100,000', change: '+14%', icon: '👗', color: '#000000', type: 'app', storeUrl: 'https://www.shein.com' },
        { id: 'af18', name: 'Files by Google', publisher: 'Google LLC', downloads: '4,700,000', change: '+1%', icon: '📁', color: '#34a853', type: 'app', storeUrl: 'https://files.google.com' },
        { id: 'af19', name: '1Password', publisher: 'AgileBits Inc.', downloads: '2,900,000', change: '+6%', icon: '🔑', color: '#1a6bf5', type: 'app', storeUrl: 'https://1password.com' },
    ],
    topGrossing: [
        ...
        { id: 'ag6', name: 'PayPal', publisher: 'PayPal Inc.', revenue: '$52,000,000', change: '+4%', icon: '💳', color: '#003087', type: 'app', storeUrl: 'https://www.paypal.com' },
        { id: 'ag7', name: 'Cash App', publisher: 'Block Inc.', revenue: '$44,000,000', change: '+9%', icon: '💵', color: '#00d64f', type: 'app', storeUrl: 'https://cash.app' },
        { id: 'ag8', name: 'Calm', publisher: 'Calm.com LLC', revenue: '$38,000,000', change: '+12%', icon: '🧘', color: '#6ba3d6', type: 'app', storeUrl: 'https://www.calm.com' },
        { id: 'ag9', name: 'Duolingo', publisher: 'Duolingo Inc.', revenue: '$35,000,000', change: '+21%', icon: '🦉', color: '#84cc16', type: 'app', storeUrl: 'https://www.duolingo.com' },
        { id: 'ag10', name: 'Strava', publisher: 'Strava Inc.', revenue: '$28,000,000', change: '+8%', icon: '🏃', color: '#fc4c02', type: 'app', storeUrl: 'https://www.strava.com' },
        { id: 'ag11', name: 'Pinterest', publisher: 'Pinterest Inc.', revenue: '$31,000,000', change: '+6%', icon: '📌', color: '#e60023', type: 'app', storeUrl: 'https://www.pinterest.com' },
        { id: 'ag12', name: 'SHEIN', publisher: 'SHEIN Group', revenue: '$26,000,000', change: '+19%', icon: '👗', color: '#000000', type: 'app', storeUrl: 'https://www.shein.com' },
        { id: 'ag13', name: 'Facetune', publisher: 'Lightricks Ltd.', revenue: '$18,000,000', change: '+7%', icon: '✨', color: '#7c3aed', type: 'app', storeUrl: 'https://www.facetuneapp.com' },
    ],
    topFeatured: [
        ...
        { id: 'afu6', name: 'Khan Academy', score: 502, icon: '📚', color: '#14b8a6', type: 'app', storeUrl: 'https://www.khanacademy.org' },
        { id: 'afu7', name: 'Strava', score: 488, icon: '🏃', color: '#fc4c02', type: 'app', storeUrl: 'https://www.strava.com' },
        { id: 'afu8', name: 'Calm', score: 471, icon: '🧘', color: '#6ba3d6', type: 'app', storeUrl: 'https://www.calm.com' },
        { id: 'afu9', name: 'MyFitnessPal', score: 445, icon: '🥗', color: '#4caf50', type: 'app', storeUrl: 'https://www.myfitnesspal.com' },
        { id: 'afu10', name: 'VSCO', score: 432, icon: '📸', color: '#1a1a1a', type: 'app', storeUrl: 'https://vsco.co' },
        { id: 'afu11', name: 'Facetune', score: 418, icon: '✨', color: '#7c3aed', type: 'app', storeUrl: 'https://www.facetuneapp.com' },
        { id: 'afu12', name: 'Pinterest', score: 510, icon: '📌', color: '#e60023', type: 'app', storeUrl: 'https://www.pinterest.com' },
        { id: 'afu13', name: 'Etsy', score: 395, icon: '🛍️', color: '#f56400', type: 'app', storeUrl: 'https://www.etsy.com' },
        { id: 'afu14', name: 'SHEIN', score: 380, icon: '👗', color: '#000000', type: 'app', storeUrl: 'https://www.shein.com' },
        { id: 'afu15', name: 'Files by Google', score: 365, icon: '📁', color: '#34a853', type: 'app', storeUrl: 'https://files.google.com' },
        { id: 'afu16', name: '1Password', score: 352, icon: '🔑', color: '#1a6bf5', type: 'app', storeUrl: 'https://1password.com' },
    ]
};
...
// Low Competition Categories — categories with opportunity gaps
export const lowCompetitionData = [
    {
        category: 'Educational / EdTech Gaming',
        icon: '🎓',
        color: '#06b6d4',
        gamesInMarket: 312,
        monthlyDownloads: 8_400_000,
        avgRevenue: '$2.1M',
        competitionScore: 18, // 0-100; lower = less competition
        opportunityScore: 84,
        cagr: '+22%',
        rationale: 'High parental spend, low saturation. Most titles are outdated UI/UX.',
        topGaps: ['Adaptive learning loops', 'Gamified curriculum (K-12)', 'Multilingual support'],
    },
    {
        category: 'Simulation (Life / Farm)',
        icon: '🌾',
        color: '#10b981',
        gamesInMarket: 487,
        monthlyDownloads: 14_200_000,
        avgRevenue: '$3.8M',
        competitionScore: 24,
        opportunityScore: 79,
        cagr: '+18%',
        rationale: 'Stardew Valley effect: players crave chill experience. Mobile lacks premium titles.',
        topGaps: ['Cozy aesthetic simulation', 'Cooperative farm games', 'Cross-platform cloud save'],
    },
    {
        category: 'Niche RPG (Tabletop / TRPG)',
        icon: '🎲',
        color: '#8b5cf6',
        gamesInMarket: 134,
        monthlyDownloads: 3_900_000,
        avgRevenue: '$5.2M',
        competitionScore: 12,
        opportunityScore: 91,
        cagr: '+31%',
        rationale: 'D&D / tabletop audience is underserved on mobile. High ARPU potential.',
        topGaps: ['AI dungeon master mechanics', 'Asynchronous multiplayer campaigns', 'Character sheet management'],
    },
    {
        category: 'Fitness / Wellness Gaming',
        icon: '💪',
        color: '#f59e0b',
        gamesInMarket: 203,
        monthlyDownloads: 6_100_000,
        avgRevenue: '$1.9M',
        competitionScore: 21,
        opportunityScore: 76,
        cagr: '+25%',
        rationale: 'Post-pandemic health focus. Ring Fit proved the market; mobile gap remains wide.',
        topGaps: ['AR walking adventures', 'Step-based RPG progression', 'Team fitness challenges'],
    },
    {
        ...
        color: '#ec4899',
        gamesInMarket: 278,
        monthlyDownloads: 5_300_000,
        avgRevenue: '$4.4M',
        competitionScore: 16,
        opportunityScore: 88,
        cagr: '+28%',
        rationale: 'Otome/romance games show very high LTV. Underexplored by Western studios.',
        topGaps: ['Branching AI-powered storylines', 'Diverse representation', 'Episodic subscription models'],
    },
    {
        category: 'Indie Puzzle / Brain Training',
        icon: '🧠',
        color: '#3b82f6',
        gamesInMarket: 621,
        monthlyDownloads: 11_000_000,
        avgRevenue: '$1.4M',
        competitionScore: 29,
        opportunityScore: 72,
        cagr: '+14%',
        rationale: 'Wordle-effect shows daily puzzle potential. Few polished mobile titles exist.',
        topGaps: ['Social sharing mechanics', 'Daily challenge streaks', 'Offline-first design'],
    },
];
